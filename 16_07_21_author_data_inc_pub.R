...
names.data <- data[,c(1,yr.ind,auth.ind,pub.ind)]
rm(data,yr.ind,auth.ind,pub.ind)
#
...
#
# Merge author columns
#
ind <- grep(".",names.data[,4])
names.data[ind,3] <- paste(names.data[ind,3],names.data[ind,4],sep = " & ")
